...
namespace MLLearning
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\dbkschan\Documents\Visual Studio 2022\Projects\MLLearning\MLLearning\Data.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.05576654F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
